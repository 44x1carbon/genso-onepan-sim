...
<div class="border shadow">
	...
	<div class="flex justify-between p-2">
		<button class="border rounded p-1 w-20 bg-gray-200 border-gray-400" on:click={() => (step -= 1)}
			>戻る</button
		>
		<div>
			{step + 1}/{maxStep}
						...
						<div class="form-controll flex flex-1 gap-4">
							<div class="flex  items-center">
								...
								<div class="flex items-center ml-2">
									...
									<input type="number" class="border w-20" bind:value={currentState.spring.cost} />
				...
				<div>
					<div class="form-row">
						...
						<div class="form-controll flex flex-1">
							...
							<input type="number" class="border w-20" bind:value={otherInfo.rate['ROND-mRond']} />
						</div>
					</div>
					<div class="form-row">
					...
					<div class="form-row">
						...
						<div class="form-controll flex flex-1">
							<input type="number" class="border w-20 " bind:value={otherInfo.rate['USD-JPY']} />
...
<img src="" id="result-img" class="mt-1" />
<div class="text-center leading-tight p-1 bg-gray-900 text-white">
	画像をダウンロードしてツイートしよう！<br />
	<span class="text-xs">スマホは画像長押し、PCは右クリックでダウンロードできます。</span>
</div>
<a
	class="bg-blue-400 text-white font-bold w-full text-center rounded-md p-2 mt-2 block"
...
<div
	class="bg-orange-900 text-white result font-bold border-4 border-amber-400 rounded p-2 fixed top-0 left-0 w-full -z-50"
	id="result"
>
